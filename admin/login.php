...
?>
		...
		<div class="navbar-inner" style="background: linear-gradient(to right, #00416A, #E4E5E6) !important; " >
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand" href="index.php">
			  		<p style="letter-spacing: 2px; color: #fefefe">Hệ thống quản trị Admin</p>
			  	</a>
	...
	<div class="footer">
        <div class="container">
            <p class="copyright" style="color:#009FFF !important"> Designed by : Mai Hồng Ngự, Ngô Trường Hải, Võ Xuân Hậu </p>
        </div>
    </div>
</body>
</html>
