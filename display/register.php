...
<?php
            ...
            if($_SERVER["REQUEST_METHOD"]=="POST")
            {
                ...
                if (empty($error))
                {             
                    $query = "insert into khachhang(tendangnhap, matkhau, hoten ,diachi , email, sdt,trangthai, ngaytao) values('$tendn', '$matkhau', '$hoten', '$diachi', '$email', 0 ,'$sdt', now())";  
                    $count=$db->exec($query);
                    if($count>0)
                    {
    ...
    <form action="" method="post">
                         ...
                         <div class="control-group">
                            ...
                            <div class="control-group">
                             ...
                             <button type="submit" class="single_add_to_cart_button button alt" style="text-transform: uppercase">ĐĂNG KÝ</button>
    </form>
    </div>
</div>
<?php 
