            ...
            if ($_SERVER["REQUEST_METHOD"]=='POST')
            {
                ...
                if ($username == "" || $password =="") 
                ...
                else
                    {
                        ...
                        if (!empty($rs))
                        {
                            $updatestatus = "update khachhang set trangthai = 1  where tendangnhap='".$username."'";
...
?>
    ...
    <form action="" method="post">
         ...
         <button type="submit" class="single_add_to_cart_button button alt" style="text-transform: uppercase" >Đăng nhập</button>
    </form>
</div>
</div>
<?php 
